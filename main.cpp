...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		/// ↓更新処理ここから
		///
		Matrix4x4 resrultAdd = Add(m1, m2);
		Matrix4x4 resrultMultiply = Multiply(m1, m2);
		Matrix4x4 resrultSubtract = Subtract(m1, m2);
		...
		/// ↓描画処理ここから
		///
		MatrixScreenPrintf(0, 0, resrultAdd, "Add");
		MatrixScreenPrintf(0, kRowHeight * 5 , resrultSubtract, "Sudtract");
		MatrixScreenPrintf(0, kRowHeight * 5 * 2,  resrultMultiply, "Multiply");
